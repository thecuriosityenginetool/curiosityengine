...
export default function Home() {
  ...
  // Not authenticated - show modern landing page
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:py-40">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl mb-6 leading-tight">
                Get back <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">one hour</span><br />every day
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                <Link 
                  href="/signup"
                  className="w-full sm:w-auto px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-lg shadow-indigo-500/30 transition-all hover:shadow-indigo-500/50 hover:scale-105 text-lg"
                >
                  Start free trial
                </Link>
                <Link 
                  href="/login"
                  className="w-full sm:w-auto px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-semibold rounded-lg border border-slate-700 transition-all hover:border-slate-600 text-lg"
                >
                  Sign In
                </Link>
              </div>
              ...
              <div className="flex flex-col items-center gap-4">
                <p className="text-sm text-slate-400">Trusted by sales teams at</p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-50">
                  <div className="text-slate-400 font-semibold text-sm">Microsoft</div>
                  <div className="text-slate-400 font-semibold text-sm">Salesforce</div>
                  <div className="text-slate-400 font-semibold text-sm">HubSpot</div>
                  <div className="text-slate-400 font-semibold text-sm">Monday.com</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="rounded-3xl border border-slate-800 bg-slate-900/50 p-12 backdrop-blur-sm">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center rounded-full bg-purple-500/10 px-4 py-1.5 text-sm font-medium text-purple-300 ring-1 ring-inset ring-purple-500/20 mb-6">
              ...
              <div className="relative">
                <div className="rounded-2xl border border-slate-700 bg-slate-800/50 p-6 shadow-2xl">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-400">Trained on 2,847 sent emails</div>
                    </div>
                  </div>
        ...
        <section className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="text-center mb-16">
            <div className="inline-flex items-center rounded-full bg-indigo-500/10 px-4 py-1.5 text-sm font-medium text-indigo-300 ring-1 ring-inset ring-indigo-500/20 mb-6">
              🚀 Chrome Extension
            </div>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/50 p-12 backdrop-blur-sm">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-500/10 text-blue-400 mb-4 mx-auto">
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-purple-500/10 text-purple-400 mb-4 mx-auto">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-cyan-500/10 text-cyan-400 mb-4 mx-auto">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-12 text-center">
              <Link
                href="/install"
                className="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 text-white text-lg font-semibold rounded-lg hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-500/30 hover:scale-105"
              >
        ...
        <section className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="text-center mb-16">
            <div className="inline-flex items-center rounded-full bg-green-500/10 px-4 py-1.5 text-sm font-medium text-green-300 ring-1 ring-inset ring-green-500/20 mb-6">
              🔌 Integrations
            </div>
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Gmail */}
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6 backdrop-blur-sm hover:border-slate-700 transition-all">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Email & Calendar</p>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6 backdrop-blur-sm hover:border-slate-700 transition-all">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">CRM & Project Management</p>
                </div>
              </div>
              <p className="text-sm text-slate-300">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6 backdrop-blur-sm hover:border-slate-700 transition-all">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Sales Navigator</p>
                </div>
              </div>
              <p className="text-sm text-slate-300">
        ...
        {/* CTA Section */}
        <section className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="rounded-3xl border border-indigo-800 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 p-12 text-center backdrop-blur-sm">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/signup"
                className="px-8 py-4 bg-white text-indigo-900 font-bold rounded-lg shadow-lg hover:bg-slate-100 transition-all hover:scale-105 text-lg"
              >
                Start Free Trial
              </Link>
              <Link 
                href="/install"
                className="px-8 py-4 bg-indigo-600 text-white font-semibold rounded-lg border border-indigo-500 transition-all hover:bg-indigo-700 text-lg"
              >
          ...
          <div className="mx-auto max-w-7xl px-6 py-12">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex gap-6 text-sm">
                ...
                <Link href="/install" className="text-slate-400 hover:text-white transition">
                  Download Extension
                </Link>
              </div>
            </div>
  ...
  // Authenticated - show app features (keeping existing functionality)
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      {/* Hero */}
      <section className="relative isolate overflow-hidden">
