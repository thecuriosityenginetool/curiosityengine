-- Sales Curiosity Engine - Fresh Installation Schema
-- For NEW deployments without existing users
...
-- You can now test by creating a new user through your signup page
-- Individual accounts will get a personal workspace
-- Organization accounts will get team management features
